...
let closee =document.querySelector('.close-product .box')


let close_product =document.querySelector('.close-product')
// console.log(box);

let dayy = document.querySelector('#dayy')
let hourss = document.querySelector('#hourss')
let mintess = document.querySelector('#mintess')
let secondess = document.querySelector('#secondess')
...
setInterval(()=>{
    ...
    let endYear = newDate - date



    let days = Math.floor( endYear / (1000 * 60 * 60 * 24) )
    dayy.innerHTML=(days)

    let hours =  Math.floor( endYear % (1000 * 60 * 60 * 24 ) / 1000 / 60 / 60  )
    hourss.innerHTML=(hours)

    let mintues =  Math.floor( endYear % (1000 * 60 * 60  ) / 1000 / 60   )
    mintess.innerHTML=(mintues)

    let seconds =  Math.floor( endYear % (1000 * 60  ) / 1000   )
    secondess.innerHTML=(seconds)   
